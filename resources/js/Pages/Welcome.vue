...
<template>
  ...
  <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
    ...
    <!-- <img
            id="background"
            class="absolute -left-20 top-0 lg:max-w-[2000px] sm:max-h-[1800px]"
            src="images/schoolbg.jpg" 
            alt="Background"
        /> -->
    <img
      id="background"
      class="absolute left-0 top-0 w-full h-auto lg:max-h-[1000px] object-cover lg:max-w-[2000px]"
      src="images/schoolbg.jpg"
      alt="Background"
    />
    ...
    >
      <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
        ...
        >
          ...
          <nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
            ...
            <template v-else>
              <Link
                :href="route('login')"
                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-black dark:hover:text-white/80 dark:focus-visible:ring-white lg:bg-blue-500 mr-4"
              >
                Log in
              </Link>
        ...
        <footer class="py-16 text-center text-sm text-black dark:text-white/70">
          EMNGTS v{{ laravelVersion }} (PHP v{{ phpVersion }})
        </footer>
      </div>
    </div>
  </div>
